...
class StreamSocial():
    ...
    def __init__(self):
        self.twitterApiObj = oauthsocial.TwitterAuth()._getAPIObj()
    ...
    def process_tweets(self, status,mode):
        ...
        result["linkOriginalPost"] = "https://twitter.com/{screen_name}/{id}".format(screen_name = result["screenName"], id = status.id)
        result["type"] = "tweet"
